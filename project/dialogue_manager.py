...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.chitchat_bot = ChatBot('WoCao')
        self.chitchat_bot_trainer = ChatterBotCorpusTrainer(self.chitchat_bot)

        # Train based on the english corpus
        self.chitchat_bot_trainer.train("chatterbot.corpus.english")
